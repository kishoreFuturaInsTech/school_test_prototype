...
import GroupTypeAdd from "./GroupTypeAdd";
...
const GroupType = () => {
  ...
  const handleDelete = (oldData) => {
    ...
    if (confirm) {
      axios
        .patch(
          `http://localhost:8090/group/softDelete/${oldData}`,
          {},
          {
            headers: {
  ...
  const globalsearch = (val) => {
    val === ""
      ? getData()
      : axios
          .get(`http://localhost:8090/group/search/${val}`, {
            headers: {
              Authorization: `Bearer ${sessionStorage.getItem("token")}`,
            },
          })
                ...
                {data
                  ...
                  .map((value, index) => (
                    ...
                    >
                      ...
                      <TableCell align="left">{value.groupName}</TableCell>
                      <TableCell align="left">{value.groupColor}</TableCell>
